...
export function canaryEnvironment(
  ...
  return {
    ...
    POWERSYNC_USER_VALUE_SERVICE_CPUS: base.POWERSYNC_USER_VALUE_SERVICE_CPUS ?? '1.5',
    POWERSYNC_USER_VALUE_SERVICE_MEMORY: base.POWERSYNC_USER_VALUE_SERVICE_MEMORY ?? '2g',
    POWERSYNC_USER_VALUE_MONGO_CPUS: base.POWERSYNC_USER_VALUE_MONGO_CPUS ?? '2.5',
    POWERSYNC_USER_VALUE_MONGO_MEMORY: base.POWERSYNC_USER_VALUE_MONGO_MEMORY ?? '6g',
