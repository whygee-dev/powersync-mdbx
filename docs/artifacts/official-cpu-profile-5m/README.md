...
This is not the canary topology, and these timings are not comparable to canary timings:

- The service and MongoDB containers ran without CPU or memory limits on the Docker Desktop VM (Linux/aarch64, 6 CPUs, 16,748,593,152 bytes of memory). The symmetric canary caps the official target at 1.5 CPUs/2 GiB for the service and 2.5 CPUs/6 GiB for MongoDB, so the idle share below is not an artifact of CPU throttling.
...
The raw profiles are not checked into Git:

| File | Bytes | SHA-256 |
| --- | ---: | --- |
| `CPU.20260719.041039.1.0.001.cpuprofile` | 4,569,630 | `eb69b0b70f2c2158fce63e5d1d2232ef001e4ac5d72fb64a432be20bbd64014a` |
| `CPU.20260719.041913.1.0.001.cpuprofile` | 5,015,664 | `80e4ef70ccba9468258b80f61cd5f3fe50903b68e1dab115e94e8460ec953810` |
| `CPU.20260719.042824.1.0.001.cpuprofile` | 4,880,842 | `4318aed5bd867bd06475718abf9a8778650645af6fa44fefc23c5253e91c13f6` |
